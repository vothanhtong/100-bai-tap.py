...
# a = list(map(int, input("Nhập các số nguyên cách nhau bằng khoảng trắng: ").split()))
...
# Nhập list số nguyên
# L = list(map(int, input("Nhập vào danh sách các số nguyên, cách nhau bởi dấu cách: ").split()))
# # Nhập vào 2 số nguyên dương a và b
# a = int(input("Nhập số nguyên dương a (a < b < len(L)): "))
# b = int(input("Nhập số nguyên dương b (a < b < len(L)): "))
# # Kiểm tra điều kiện a < b < len(L)
# if a < b < len(L):
#     # Lấy đoạn con từ vị trí a đến b
#     sub_list = L[a:b+1]  
#     # Tìm số nhỏ nhất trong đoạn này
#     min_value = min(sub_list)
#     # In ra số nhỏ nhất
#     print(f"Số nhỏ nhất trong đoạn từ vị trí {a} đến {b} là: {min_value}")
# else:
#     print("Giá trị a hoặc b không hợp lệ (cần thỏa mãn a < b < len(L)).")
# BÀI 55: Nhập vào một list số nguyên L, hãy kiểm tra xem tất cả các phần tử trong mảng có bằng nhau 
# hay không, nếu có thì in True, không có thì in False
# Nhập list số nguyên
# L = list(map(int, input("Nhập vào danh sách các số nguyên, cách nhau bởi dấu cách: ").split()))
...
#         found = True
#         break
# # Nếu không tìm thấy giá trị dương, in ra -1
# if not found:
#     print(-1)
...
# # Kiểm tra và in ra giá trị âm lớn nhất hoặc 0 nếu không có
# if negative_numbers:
...
# print(f"Giá trị xa {x} nhất trong list là: {farthest_value}")
...
# if len(L) > 0:
#     average = sum(L) / len(L)
#     print(f"Giá trị trung bình của list là: {average}")
# else:
